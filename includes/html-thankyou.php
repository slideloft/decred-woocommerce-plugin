 ...
 */
wp_localize_script(
	'decred-main', 'ajax_action', [
		'url'   => admin_url( 'admin-ajax.php' ),
		'nonce' => wp_create_nonce( 'ajaxnonce' ),
	]
);

$decred_options = get_option('woocommerce_decred_settings');
$dcr_payment_address = $decred_options['master_public_key'];
$dcr_code = $dcr_payment_address;
	...
	<div class="decred-pay-content">
		...
		<div class="decred-pay-info">
			<div class="decred-pay-row decred-pay-row_head">
				...
				<button class="decred-pay-status decred-pay-status__processing" <?php echo 'processing' !== $dcr_order_status ? 'style="display: none"' : ''; ?>><i class="decred-icon_confirmed">&#10003;</i>Confirmed</button>
				<button class="decred-pay-status decred-pay-status__on-hold" <?php echo 'on-hold' !== $dcr_order_status ? 'style="display: none"' : ''; ?>><i class="decred-icon_dots">...</i>Processing</button>
				<button class="decred-pay-status decred-pay-status__pending" <?php echo 'pending' !== $dcr_order_status ? 'style="display: none"' : ''; ?>><i class="decred-icon_dots">...</i>Pending</button>
			</div>
